"""
Django settings for ntr_40328 project.
...
WSGI_APPLICATION = 'ntr_40328.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "ntr_40328 API",
    "DESCRIPTION": "API documentation for ntr_40328 App",
    "VERSION": "v1",
}
